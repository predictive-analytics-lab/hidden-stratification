...
class CelebADataset(GEORGEDataset):
    ...
    def __init__(
        ...
        self.split_inds_filename = split_inds_filename or "list_eval_partition.csv"
    ...
    def _load_samples(self):
        ...
        attrs_df = pd.read_csv(
            os.path.join(self.root, "celebA", "list_attr_celeba.csv"),
        ...
        split_df = pd.read_csv(
            os.path.join(self.root, "celebA", self.split_inds_filename),
            delim_whitespace=True,
        )
